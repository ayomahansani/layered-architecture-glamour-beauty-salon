...
public class Appointment {
    ...
    public Appointment(String appointmentId, String customerId, String appDate, String appTime, double appAmount, String serviceId, String staffId, List<AppointmentTm> appTmList) {
